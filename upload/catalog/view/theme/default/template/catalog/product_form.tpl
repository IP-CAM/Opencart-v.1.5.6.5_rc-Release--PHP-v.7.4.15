...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
     ...
     <div class="buttons">
<a href="<?php echo HTTP_CATALOG.'index.php?route=product/product&product_id='.(int) $_GET['product_id']; ?>" target="_blank" class="button"><?php echo 'Preview'; ?></a>
      ...
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a></div>
        ...
        <table class="form">
             ...
             <tr>
              ...
              <td><input type="text" id="model" name="model" value="<?php echo $model; ?>" />
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">             
              <tr>
                ...
                <td><input type="text" id="nombre<?php echo $language['language_id']; ?>" name="product_description[<?php echo $language['language_id']; ?>][name]" size="100" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" />                 
             ...
             <tr>
                ...
                <td><input id="tag<?php echo $language['language_id']; ?>" type="text" name="product_description[<?php echo $language['language_id']; ?>][tag]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['tag'] : ''; ?>" size="80" /></td>
              </tr>  
              <tr>
                <td><?php echo $entry_meta_description; ?></td>
                <td><textarea id="metadesc<?php echo $language['language_id']; ?>" name="product_description[<?php echo $language['language_id']; ?>][meta_description]" cols="40" rows="5"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_description'] : ''; ?></textarea></td>
              </tr>
              <tr>
                <td><?php echo $entry_meta_keyword; ?></td>
                <td><textarea id="keywords<?php echo $language['language_id']; ?>" name="product_description[<?php echo $language['language_id']; ?>][meta_keyword]" cols="40" rows="5"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea></td>
              </tr>
              <tr>
                <td colspan="2"><?php echo $entry_description; ?><p>
                <textarea name="product_description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description'] : ''; ?></textarea></td>
              </tr>             
            </table>
          </div>
          <?php } ?>           
		...
		$("#nombre2").keyup(function () {	
			 var value = $(this).val();	
	 changed = value.toLowerCase().replace(/ /g, '-').replace('"','').replace('á','a').replace('é','e').replace('í','i').replace('ó','o').replace('ú','u').replace('ñ','n').replace('(','').replace(')','').replace('/','-').replace('ä','a').replace('ë','e').replace('ï','i').replace('ö','o').replace('ü','u').replace(',','').replace('&copy;','').replace('™','');
	 minusculas = value.toLowerCase();
  taggs = value.toLowerCase().replace('ñ','n').replace('(','').replace(',','').replace(')','').replace('/',' y ').replace(' de ',' ').replace(' con ',' ').replace(' y ',' ').replace(/ /g, ', ');  
	$("#model").val(changed);
    $("#keyword").val(changed);
	$("#metadesc2").val(minusculas);
    $("#tag2").val(taggs);
    $("#keywords2").val(taggs);
    $("#metatag2").val(taggs);
    }).keyup();
	$("#nombre5").keyup(function () {	
			 var value2 = $(this).val();	
	 changed2 = value2.toLowerCase().replace(/ /g, '-').replace('á','a').replace('é','e').replace('í','i').replace('ó','o').replace('ú','u').replace('ñ','n').replace('(','').replace(')','').replace('/','').replace('ä','a').replace('ë','e').replace('ï','i').replace('ö','o').replace('ü','u').replace(',','');
	 minusculas2 = value2.toLowerCase();
  taggs2 = value2.toLowerCase().replace('ñ','n').replace('(','').replace(',','').replace(')','').replace('/','').replace(' de ',' ').replace(' con ',' ').replace(' y ',' ').replace(/ /g, ', ');  	$("#metadesc5").val(minusculas2);
    $("#tag5").val(taggs2);
    $("#keywords5").val(taggs2);
    $("#metatag5").val(taggs2);
    }).keyup();
</script>
        </div>
...
// JTI MOD - Can't remove manufacturer from product!  - Qphoria
...
function addImage() {
	...
	html += '  <tr>';
	html += '    <td class="left"><div class="image"><img src="<?php echo $no_image; ?>" alt="" id="thumb' + image_row + '" /><input type="hidden" name="product_image[' + image_row + '][image]" value="" id="image' + image_row + '" /><br /><a class="button" onclick="image_upload(\'image' + image_row + '\', \'thumb' + image_row + '\');"><?php echo $text_browse; ?></a>&nbsp;<a class="button" onclick="$(\'#thumb' + image_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#image' + image_row + '\').attr(\'value\', \'\');"><?php echo $text_clear; ?></a></div></td>';
...
function addMultiImage(filename) {
    ...
    html  = '<tbody id="image-row' + image_row + '">';
	html += '<tr>';
	html += '<td class="left"><div class="image"><img src="<?php echo $no_image; ?>" alt="" id="thumb' + image_row + '" title="' + image_row + '" /><input type="hidden" name="product_image[' + image_row + '][image]" value="data/'+filename+'" id="image' + image_row + '" /><br /><a class="button"  onclick="image_upload(\'image' + image_row + '\', \'thumb' + image_row + '\');" ><?php echo $text_browse; ?></a>&nbsp;<a class="button" onclick="$(\'#thumb' + image_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#image' + image_row + '\').attr(\'value\', \'\');"><?php echo $text_clear; ?></a></div></td>';
